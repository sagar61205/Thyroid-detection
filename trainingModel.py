...
class trainModel:
    ...
    def trainingModel(self):
        ...
        try:
            ...
            data = preprocessor.dropUnnecessaryColumns(data,['TSH_measured','T3_measured','TT4_measured','T4U_measured','FTI_measured','TBG_measured','referral_source','TBG'])
            print('Error is 2')
            ...
            if(is_null_present):
                X=preprocessor.median_imputation(X) # missing value imputation
            print('Error is 7')
