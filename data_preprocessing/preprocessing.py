...
class Preprocessor:
    ...
    def impute_missing_values(self, data):
        ...
        try:
            ...
            self.new_data=pd.DataFrame(np.round(self.new_array), columns=self.data.columns)
    ...
    def median_imputation(self, data):
        ...
        try:
            for feature in self.data:
                ...
                self.data[feature] = self.data[feature].fillna(median) # impute the missing values
